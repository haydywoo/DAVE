      ...
      <div className="mx-auto max-w-screen-xl px-6 h-14 flex items-center gap-4">
        ...
        <nav className="flex items-center gap-1 sm:gap-2 ml-auto">
          ...
          <a
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-fg-secondary hover:text-foreground transition-colors rounded-[3px] hover:bg-surface"
          >
