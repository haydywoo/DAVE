      ...
      <section className="mx-auto max-w-7xl px-6 pt-20 pb-24">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg text-fg-secondary max-w-xl leading-relaxed">
            DAVE (DesignAdVancedEngineering) is an open-source design system built for experimentation on top of core web technologies. It covers basic & advanced components, charts and AI features.
          </p>
