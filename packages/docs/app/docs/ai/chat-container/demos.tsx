...
export function ChatContainerDemos() {
  return (
    <>
      ...
      <Preview
        code={`<div className="h-[400px] flex flex-col border border-border rounded-[6px] overflow-hidden">
  ...
  <div className="p-3 border-t border-border">
    <MessageInput onSubmit={(v) => console.log(v)} />
      ...
      >
        <div className="h-[400px] flex flex-col border border-border rounded-[6px] overflow-hidden">
          <ChatContainer className="flex-1">
            {MESSAGES.map((msg, i) => (
