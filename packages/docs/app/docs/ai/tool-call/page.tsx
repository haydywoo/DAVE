...
export default function ToolCallPage() {
  return (
    <div>
      <h1 className="font-display font-semibold text-4xl text-foreground mb-2">ToolCall</h1>
      ...
      <h2 className="font-display font-semibold text-2xl text-foreground mt-12 mb-4 pt-8 border-t border-border">ToolCall Props</h2>
      <PropsTable props={toolCallProps} />

      <h2 className="font-display font-semibold text-2xl text-foreground mt-12 mb-4 pt-8 border-t border-border">ToolResult Props</h2>
