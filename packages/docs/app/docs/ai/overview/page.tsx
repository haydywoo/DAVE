  ...
  return (
    <div>
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="font-display font-semibold text-4xl text-foreground">AI Components</h1>
      ...
      <h2 className="font-display font-semibold text-2xl text-foreground mt-10 mb-4 pt-8 border-t border-border">Chat & Messaging</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
        {[
          ...
          <Link key={item.name} href={item.href} className="rounded-[6px] border border-border bg-card p-4 shadow-card hover:bg-surface hover:border-border-strong transition-colors">
      ...
      <h2 className="font-display font-semibold text-2xl text-foreground mt-10 mb-4 pt-8 border-t border-border">Streaming & Generation</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
        {[
      ...
      <h2 className="font-display font-semibold text-2xl text-foreground mt-10 mb-4 pt-8 border-t border-border">Tools & Actions</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
        {[
      ...
      <h2 className="font-display font-semibold text-2xl text-foreground mt-10 mb-4 pt-8 border-t border-border">Controls</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
        {[
