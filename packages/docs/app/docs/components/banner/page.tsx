...
export default function BannerPage() {
  return (
    <div>
      <h1 className="font-display font-semibold text-4xl text-foreground mb-2">Banner</h1>
      ...
      <h2 className="font-display font-semibold text-2xl text-foreground mt-12 mb-6 pt-8 border-t border-border">Usage</h2>
