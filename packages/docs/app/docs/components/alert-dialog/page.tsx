...
export default function AlertDialogPage() {
  return (
    <div>
      <h1 className="font-display font-semibold text-4xl text-foreground mb-2">Alert Dialog</h1>
  ...
  <AlertDialogContent>
    ...
    <AlertDialogFooter>
      ...
      <h2 className="font-display font-semibold text-2xl text-foreground mt-12 mb-4 pt-8 border-t border-border">AlertDialogAction props</h2>
