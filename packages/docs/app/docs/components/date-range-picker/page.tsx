...
export default function DateRangePickerPage() {
  return (
    <div>
      <h1 className="font-display font-semibold text-4xl text-foreground mb-2">DateRangePicker</h1>
      ...
      <h2 className="font-display font-semibold text-2xl text-foreground mt-12 mb-4 pt-8 border-t border-border">DateRangePicker props</h2>
      <PropsTable props={pickerProps} />

      <h2 className="font-display font-semibold text-2xl text-foreground mt-12 mb-4 pt-8 border-t border-border">RangeCalendar props</h2>
