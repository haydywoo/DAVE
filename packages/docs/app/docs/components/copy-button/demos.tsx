...
export function CopyButtonDemos() {
  return (
    <>
      <Preview
        code={`<CopyButton value="npm install @dave/react" />`}
      >
        <CopyButton value="npm install @dave/react" />
      </Preview>

      <h3 className="font-semibold text-base text-foreground mt-8 mb-3">With label</h3>
      <Preview
        code={`<CopyButton value="npm install @dave/react" label="Copy" />`}
      >
        <CopyButton value="npm install @dave/react" label="Copy" />
      </Preview>
...
<CopyButton value="text" variant="solid" />`}
  ...
  <code className="text-sm font-mono">npm install @dave/react</code>
  <CopyButton value="npm install @dave/react" variant="ghost" size="sm" />
      ...
      >
        <div className="flex items-center justify-between gap-4 rounded-[3px] border border-border bg-surface px-4 py-3 w-full max-w-sm">
          <code className="text-sm font-mono text-foreground">npm install @dave/react</code>
          <CopyButton value="npm install @dave/react" variant="ghost" size="sm" />
        </div>
      </Preview>
    </>
