...
export default function CommandPage() {
  return (
    <div>
      ...
      <pre className="font-code text-xs text-fg-secondary bg-surface border border-border rounded-[3px] p-4 mb-8 leading-relaxed">{`<CommandDialog open={open} onOpenChange={setOpen}>
