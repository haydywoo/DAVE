  ...
  return (
    <div>
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="font-display font-extrabold text-3xl text-foreground">Observable Plot</h1>
      ...
      <div className="rounded-[6px] border border-border bg-surface p-5 mb-10 text-sm text-fg-secondary leading-relaxed">
        <p className="font-semibold text-foreground mb-1">What we're testing</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {[
          ...
          <Link key={href} href={href} className="rounded-[6px] border border-border bg-card p-4 hover:bg-surface hover:border-border-strong transition-colors">
